...
urlpatterns = [
    ...
    path('favourite/<slug:slug>', views.BookmarkBook.as_view(), name='book_favourite'),
    ...
    path('<int:pk>/admin_delete_review/', views.DeleteReviewAdmin.as_view(), name='delete_review_admin' ),
]